    ...
    function submitPatientRegistrationForm() {
        ...
        if (triger) {
            ...
            $.ajax({
                ...
                async: false,
                type: 'POST',
                data: {_token: "{{ csrf_token() }}", type: patType, cat: cat, staff_id: staff_id, dept_id: dept_id, ic_number: ic_number, name: name, queueno: queueno, symptopms: symptopms, dept: dept, department_id: department_id},
